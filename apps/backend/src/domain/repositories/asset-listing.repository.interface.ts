...
export interface IAssetListingRepository {
  ...
  create(listing: Omit<AssetListing, 'id' | 'createdAt' | 'updatedAt' | 'priceRecords'>): Promise<AssetListing>;
  update(id: string, listing: Partial<AssetListing>): Promise<AssetListing | null>;
